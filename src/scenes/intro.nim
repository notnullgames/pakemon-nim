...
method load*(this:SceneIntro) =
  ...
  this.layer1 = ParalaxLayer(
    offsetY: 0,
    scroll: 0,
    speed: -0.1,
    image: LoadTexture("assets/far-buildings.png")
  )
  this.layer2 = ParalaxLayer(
    offsetY: 0,
    scroll: 0,
    speed: -0.5,
    image: LoadTexture("assets/back-buildings.png")
  )
  this.layer3 = ParalaxLayer(
    offsetY: 50,
    scroll: 0,
    speed: -1.0,
    image: LoadTexture("assets/foreground.png")
  )
  this.cat = Spritesheet(
    playing: true,
    image: LoadTexture("assets/cat.png"),
