...
proc CompressData*(data: UncheckedArray[byte]; dataLength: int32; compDataLength: pointer): uint8 {.RLAPI, importc: "CompressData".} # Compress data (DEFLATE algorithm)
proc DecompressData*(compData: UncheckedArray[byte]; compDataLength: int32; dataLength: pointer): uint8 {.RLAPI, importc: "DecompressData".} # Decompress data (DEFLATE algorithm)
proc EncodeDataBase64*(data: UncheckedArray[byte]; dataLength: int32; outputLength: pointer): ptr char {.RLAPI, importc: "EncodeDataBase64".} # Encode data to Base64 string
proc DecodeDataBase64*(data: UncheckedArray[byte]; outputLength: pointer): uint8 {.RLAPI, importc: "DecodeDataBase64".} # Decode Base64 string data
